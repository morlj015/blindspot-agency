...
function injectMascot() {
  ...
  wrapper.innerHTML += `
    ...
    >
      ...
      <!-- Right leg -->
      <g id="m-leg-r">
        <line x1="59" y1="76" x2="70" y2="130" stroke="#c9a84c" stroke-width="4.5" stroke-linecap="round"/>
        <ellipse cx="72" cy="135" rx="11" ry="5" fill="#c9a84c"/>
      </g>

      <!-- Left leg -->
      <g id="m-leg-l">
        <line x1="41" y1="76" x2="30" y2="130" stroke="#c9a84c" stroke-width="4.5" stroke-linecap="round"/>
...
function mascotLoop(timestamp) {
  ...
  rotateLimb('m-leg-l', legL, mascot.pivots.legL);
  rotateLimb('m-leg-r', legR, mascot.pivots.legR);
